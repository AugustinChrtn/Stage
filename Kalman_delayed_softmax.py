...
class Kalman_agent_delayed_softmax(): 
    
    def __init__(self, environment, gamma=0.8, variance_ob=10,variance_tr=0.1,curiosity_factor=3,gamma_curiosity=0.5,alpha=0.3):
