...
class Kalman_agent_raffine_faux(): 
    ...
    def learn(self, old_state, reward, new_state, action):
        ...
        self.KF_table_curiosity[old_state][action] = ((current_variance+self.variance_tr)*(current_variance+self.gamma_curiosity*max_curiosity_in_new_state)+(self.variance_ob*current_mean))/ (current_variance+self.variance_tr+self.variance_ob)
